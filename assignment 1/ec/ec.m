...
datadir     = '';   %the directory containing the images
resultsdir  = ''; %the directory for dumping results
...
for i = 1:numel(imglist)
    ...
    lines = houghlines(Im>threshold, thetaScale, 180*rhoScale/pi, [rhos,thetas],'FillGap',3,'MinLength',7);
